exports.port = process.env.PORT || 3945;
exports.enable_logging = true;
exports.aurora_regex = /^\/aurora\/(.*)$/; // The URL to look for when parsing the request.
exports.proxy_request_timeout_ms = 10000; // The lenght of time we'll wait for a proxy server to respond before timing out.
exports.max_request_length = 150000; // The maximum length of characters allowed for a request or a response.
